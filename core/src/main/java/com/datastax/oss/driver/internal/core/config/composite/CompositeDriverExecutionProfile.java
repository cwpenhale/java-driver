...
public class CompositeDriverExecutionProfile implements DriverExecutionProfile {
  ...
  public CompositeDriverExecutionProfile(
      DriverConfig primaryConfig, DriverConfig fallbackConfig, String profileName) {
   ...
   * main config, not every time an option is fetched from the profile (this is consistent with how
   * a non-composed config would work).
   */
